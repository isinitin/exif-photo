<script lang="ts" module>
	...
	export type InputGroupAddonAlign = keyof typeof alignClasses;

	export function inputGroupAddonVariants(options?: { align?: InputGroupAddonAlign }): string {
		const align = options?.align ?? 'inline-start';
		return cn(baseClass, alignClasses[align]);
	}
</script>
